...
incorporar un sistema de simulación a traves de una interfaz, que consistira principalmente en una estación de trenes donde se muestre en pantalla los trenes a usar, las rutas para llegar a los diferentes destinos, las estaciones y su número de personas, el tiempo necesario para los viajes, y eventos aleatorios con toma de desiciones.
